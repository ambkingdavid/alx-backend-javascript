...
describe('calculateNumber', () => {
  ...
  describe('ADD', () => {
    ...
    it('should return 5 for input values 1.49 and 3.51', () => {
      assert.strictEqual(calculateNumber('SUM', 1.49, 3.51), 5);
    });
    ...
    it('should return 4 for input values 1.25 and 2.25', () => {
      assert.strictEqual(calculateNumber('SUM', 1.25, 2.25), 3);
    });
  
    it('should return 4 for input values 1.25 and 2.75', () => {
      assert.strictEqual(calculateNumber('SUM', 1.25, 2.75), 4);
    });
  });
